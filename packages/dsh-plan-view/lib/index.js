...
function GuideView({ scope }) {
	...
	const P = ({ children }) => /* @__PURE__ */ jsx("div", {
		style: {
			fontSize: 12.5,
			lineHeight: 1.8,
			color: TEXT_DIM,
	...
	return /* @__PURE__ */ jsx("div", {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				/* @__PURE__ */ jsx(H, { children: "断点：④ 没有承担者" }),
				/* @__PURE__ */ jsxs(P, { children: [
				...
				/* @__PURE__ */ jsxs("ul", {
					...
					children: [/* @__PURE__ */ jsxs("li", { children: [/* @__PURE__ */ jsx(Code, { children: "to-tickets" }), " 只写了一句「实现时去勾掉并改 status」——它自己不执行，也不产出执行者"] }), /* @__PURE__ */ jsxs("li", { children: [
				...
				/* @__PURE__ */ jsx(H, { children: "怎么 sync" }),
				/* @__PURE__ */ jsxs(P, { children: [
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: ["/plan-sync \xA0\xA0", /* @__PURE__ */ jsx("span", {
					...
					children: [
						/* @__PURE__ */ jsxs("div", {
							...
							children: [
								...
								"）。历史遗留的 ",
								/* @__PURE__ */ jsx(Code, { children: "impl/" }),
								"、",
								/* @__PURE__ */ jsx(Code, { children: "impl-fe/" }),
