...
function DetailModal({ ticket, planDir, scope, ctx, sessions, onChanged, onClose, readOnly }) {
	...
	const chipRow = jumps.map(([id, label]) => {
		if (!isDshSession(id)) return /* @__PURE__ */ jsxs("span", {
			...
			children: [
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [
						...
						ticket.qaCases && /* @__PURE__ */ jsx("span", {
							style: {
								fontSize: 11,
								padding: "2px 9px",
								borderRadius: 999,
						...
						ticket.qaTested && /* @__PURE__ */ jsx("span", {
							style: {
								fontSize: 11,
								padding: "2px 9px",
								borderRadius: 999,
						...
						ticket.qaAccepted && /* @__PURE__ */ jsx("span", {
							style: {
								fontSize: 11,
								padding: "2px 9px",
								borderRadius: 999,
...
function ViewA({ tickets, planDir, scope, ctx, sessions, onChanged, destination, readOnly }) {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			!readOnly && waiting.length > 0 && /* @__PURE__ */ jsxs("div", {
				style: {
					margin: "8px 16px 0",
					padding: "8px 12px",
					borderRadius: 8,
						...
						children: groups[s].map((t) => /* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("div", {
								...
								children: [
									...
									t.qaAccepted && /* @__PURE__ */ jsx("span", {
...
function OverviewView({ tickets, efforts, defects, ledgers, effortIdx, setEffortIdx, planDir, scope, ctx, sessions, onChanged, readOnly }) {
	...
	const readyTickets = useMemo(() => visible.filter((t) => ticketKind(t) === "ticket" && displayStatus(t) === "open" && !unmetBlocker(t)), [visible]);
	const stuckTickets = useMemo(() => visible.filter((t) => displayStatus(t) === "claimed" && (() => {
			...
			(() => {
				...
				return /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: ["🚀 待推进 ", /* @__PURE__ */ jsxs("span", {
							style: {
								fontWeight: 400,
								color: TEXT_FAINT
							},
						...
						children: groups.map((g) => g.rows.length === 0 ? null : /* @__PURE__ */ jsxs("div", {
							style: {
								border: `1px solid ${BORDER_LIGHT}`,
								borderRadius: 8,
								padding: "8px 10px"
							...
							}), g.rows.map((r) => row(r.ticket, /* @__PURE__ */ jsx("span", {
								style: {
									fontSize: 10,
									color: TEXT_FAINT,
									flexShrink: 0
		...
		children: [
			/* @__PURE__ */ jsxs("div", {
				...
				children: [tabs.map((t) => /* @__PURE__ */ jsxs("button", {
					...
					onClick: () => setTop(t.id),
					children: [t.label, t.id !== "guide" && /* @__PURE__ */ jsx("span", {
						style: {
							marginLeft: 5,
							fontSize: 11,
					...
					children: [rounds.length > 0 && /* @__PURE__ */ jsxs("select", {
						value: round ?? "",
...
function GuideView({ scope }) {
	const H = ({ children }) => /* @__PURE__ */ jsx("div", {
		style: {
			fontSize: 14,
			fontWeight: 700,
			color: TEXT,
	...
	const P = ({ children, style }) => /* @__PURE__ */ jsx("div", {
		style: {
			fontSize: 12.5,
			lineHeight: 1.8,
			color: TEXT_DIM,
	...
	const Code = ({ children }) => /* @__PURE__ */ jsx("code", {
		style: {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				/* @__PURE__ */ jsxs(P, { children: [
					...
					"：把多张票写进同一个文件（如 ",
					/* @__PURE__ */ jsx(Code, { children: "tickets.md" }),
					"）， 按文件读取的一方会把它当成",
					/* @__PURE__ */ jsx("strong", {
						style: { color: TEXT },
						children: "一张票"
				...
				/* @__PURE__ */ jsx(H, { children: "几个常见疑问" }),
				/* @__PURE__ */ jsxs("div", {
					style: {
						fontSize: 12.5,
						lineHeight: 1.85,
					...
					children: [
						/* @__PURE__ */ jsxs("div", {
							...
							children: [
								...
								"的活（",
								/* @__PURE__ */ jsx(Code, { children: "status: open/done" }),
								"）； 待拍板是",
								/* @__PURE__ */ jsx("strong", {
									style: { color: TEXT },
									children: "等你做决定"
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [
								...
								/* @__PURE__ */ jsx(Code, { children: ".archive/rounds/<round-id>/" }),
								"）， 按轮只读查看当时的路线 / 工单 / 拍板。"
							]
						}),
						/* @__PURE__ */ jsxs("div", {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [shown.length === 0 && /* @__PURE__ */ jsx("div", {
					style: {
						padding: 24,
						textAlign: "center",
						color: TEXT_FAINT,
...
function ChainView({ tickets, defects, ledgers, cases, planDir, scope, ctx, sessions, onChanged, readOnly }) {
	...
	const { nodes, treeEdges, crossEdges, pos, W, H, orphans } = useMemo(() => buildChain(tickets, defects, ledgers, cases), [
		tickets,
		defects,
		ledgers,
		cases
		...
		children: [
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					Object.entries(KIND_COLOR).map(([kind, c]) => /* @__PURE__ */ jsxs("span", {
						style: {
							display: "inline-flex",
							alignItems: "center",
							gap: 4,
...
function CasesView({ cases, scope, readOnly }) {
	if (cases.length === 0) return /* @__PURE__ */ jsxs("div", {
		style: {
			flex: 1,
			display: "flex",
			alignItems: "center",
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsx("style", { children: MD_CSS }), cases.map((c) => /* @__PURE__ */ jsxs("div", {
			style: {
				border: `1px solid ${BORDER}`,
				borderRadius: 10,
				background: CARD,
